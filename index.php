...
<body>
<?php include 'includes/header/header.php' ?><!--/header-->

<?php include 'includes/slider/slider.php' ?><!--/#main-slider-->
    ...
    <?php include 'includes/footer/footer.php'?><!--/#footer-->

<?php include 'includes/footer/scripts/scripts.php' ?>
</body>
</html>